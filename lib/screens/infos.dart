...
class _InfosState extends State<Infos> {
 ...
 final ButtonStyle style =
        ElevatedButton.styleFrom(textStyle: const TextStyle(fontSize: 20,color: Colors.white),backgroundColor: Color.fromRGBO(216, 97, 97, 1));
                            ...
                            return Padding(
                              ...
                              child: Center(
                                child: Stack(
                                  ...
                                  Container(decoration: BoxDecoration(color: Color.fromARGB(50, 27, 25, 25),borderRadius: BorderRadius.circular(10)),)
                                  ]
                                ),
                              ),
                            );
